        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Kumpulan artikel, tutorial, dan insight menarik seputar teknologi web development
            </p>
    ...
    {tag}
          ...
          {filteredPosts.length === 0 && !searchTerm && (
            <div className="text-center py-16">
              ...
              <p className="text-gray-600">Postingan pertama akan segera hadir!</p>
            </div>
          )}
          ...
          {filteredPosts.length === 0 && searchTerm && (
            <div className="text-center py-16">
              ...
              <p className="text-gray-600">Coba gunakan kata kunci yang berbeda atau lihat semua artikel.</p>
              <button
                onClick={() => {
                  setSearchTerm("");
                  setDisplayCount(6);
          ...
          {hasMorePosts && (
            <div className="text-center mt-12">
              ...
              >
                Muat Lebih Banyak ({filteredPosts.length - displayCount} artikel lagi)
              </button>
            </div>
          )}
